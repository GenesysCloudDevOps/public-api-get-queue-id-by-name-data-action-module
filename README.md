A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Queue ID by Name
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-queue-id-by-name-data-action-module.git?ref=main"
    action_name        = "Get Queue ID by Name"
